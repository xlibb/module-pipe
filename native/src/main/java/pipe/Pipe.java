...
public class Pipe implements IPipe {
    ...
    public static BStream consumeStream(Environment env, BObject pipe, BDecimal timeout, BTypedesc typeParam) {
        ...
        BObject streamGenerator = ValueCreator.createObjectValue(env.getCurrentModule(), Constants.STREAM_GENERATOR, resultIterator);
        ...
        return ValueCreator.createStreamValue(TypeCreator.createStreamType(typeParam.getDescribingType(),typeUnion),streamGenerator);
    }
